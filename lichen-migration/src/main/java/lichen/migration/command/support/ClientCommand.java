 ...
 */
package lichen.migration.command.support;
...
import lichen.migration.core.db.DbFactory;
import lichen.migration.core.db.DbInterface;
...
import lichen.migration.services.impl.AbstractMigration;
import lichen.migration.utils.DateTimeUtils;
	...
	private void createFile(){
		...
		if(!developmentFile.exists()){
			...
			try {
				...
				pw.println("db_script_package=com.migration.scripts");
			} catch (Exception e) {
				e.printStackTrace();
			}finally{
				pw.flush();
