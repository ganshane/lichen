...
public class Migrate_20130804213532_CreateMultiColumnIndex implements Migration {
    ...
    public void up() throws Throwable {
        ...
        //创建索引时，未指定索引名称
        _helper.addIndex("test_table", new String[]{
                "field3",
                "field1",
                "field2"
                });
        ...
        _helper.addIndex("test_table", new String[]{
                "field4",
                "field5",
                }, _options.Name("idx_test_table_4_5"));
    }
    ...
    public void down() throws Throwable {
        ...
        //删除已指定名称的索引
        _helper.removeIndex("test_table", new String[]{"field4", "field5"},
                _options.Name("idx_test_table_4_5"));

        //删除未指定名称的索引
        _helper.removeIndex("test_table", new String[]{
                "field3",
                "field1",
                "field2"});
    }
