...
public interface IterableLike<A> extends Iterable<A> {
     ...
     * @return 新的迭代器
     */
     <B> IterableLike<B> map(Function.Function1<A, B> function);
     ...
     */
     void foreach(Function.Function1<A, Void> function);
     ...
     * @return 第一个符合条件的元素
     */
     Option<A> first(Function.Function1<A, Boolean> function);
}
